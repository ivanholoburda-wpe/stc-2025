  ...
  return (
    <aside className="w-64 bg-gray-900 text-white flex flex-col p-4 border-r border-gray-800">
      ...
      <div className="flex flex-col gap-y-4">
        <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-black rounded-lg font-semibold hover:bg-gray-200 transition-colors">
      ...
      <div className="mt-auto flex flex-col gap-y-1">
        <button className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm text-gray-400 hover:bg-gray-800 hover:text-white transition-colors">
